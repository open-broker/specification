...
| **Offer rejected**      | Broker/Provider | Provider/Broker | Customer/Bank has rejected the offer                      |
...
All events changes the state of the application, except for the _Message_ event which can be sent at anytime in the
application process.
